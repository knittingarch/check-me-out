      ...
      components: {
        schemas: {
          Book: {
            ...
            required: ['id', 'title', 'isbn', 'status', 'created_at', 'updated_at', 'authors']
          },
          Author: {
            type: 'object',
            properties: {
          ...
          Pagination: {
            ...
            required: ['current_page', 'per_page', 'total_count', 'total_pages', 'has_next_page', 'has_previous_page']
          },
          Error: {
            type: 'object',
            properties: {
